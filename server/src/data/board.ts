...
export const BOARD_SPACES: BoardSpace[] = [
  ...
  { index: 25, name: 'Power Plant',    type: 'utility',  price: 150, rents: [4,8,14], mortgageValue: 75, flag: '⚡' },
  { index: 26, name: 'Surprise',       type: 'surprise' },
  { index: 27, name: 'Treasure',       type: 'treasure' },
  { index: 28, name: 'Luxury Tax',     type: 'tax',      taxAmount: 100 },
  { index: 29, name: 'Treasure',       type: 'treasure' },
  ...
  { index: 49, name: 'Water Works',    type: 'utility',  price: 150, rents: [4,8,14], mortgageValue: 75, flag: '💧' },
  ...
  { index: 56, name: 'Gas Company',    type: 'utility',  price: 150, rents: [4,8,14], mortgageValue: 75, flag: '⛽' },
